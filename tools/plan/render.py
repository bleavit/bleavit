...
RAISED_WIDTH = 25
# Narrower still: a decision row's link target is a day-file path three
# directories deep plus a heading anchor ("decisions/2026/08/2026-08-09.md
# #..."), the longest of the three link shapes this file emits.
DECISION_TITLE_WIDTH = 65
