...
`PLAN.md` and `plan/`, never alter README.md's pinned opening (thank-you to Prof. Robin Hanson)
or closing (Bon appétit) line (rule R-11, AGENTS.md), and never leave the plan tree
