...
| `frontend/` | 10 §10 monorepo root; N10 ships `packages/bleavit-client-ts`, a proof-backed PAPI bridge facade for off-chain registration, open/seal submission and finalized report reads |
