...
5. Run or inspect the relevant `try-state` result. Every pallet's machine/state
   ...
   by
   [15 §1](../../docs/architecture/15-invariants-and-testing.md#1-protocol-invariants-backend-i-1i-28-and-i-30i-33).
...
- [15 §1 — bounded-state invariants and `try-state`](../../docs/architecture/15-invariants-and-testing.md#1-protocol-invariants-backend-i-1i-28-and-i-30i-33)
