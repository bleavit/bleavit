...
//! FRAME pallet shell scaffold for the `conditional-ledger` protocol component.
//!
//! The production runtime-facing wrapper is intentionally thin: all protocol
//! state-transition semantics remain in `conditional-ledger-core`, which is the differential
...
pub use conditional_ledger_core::*;
