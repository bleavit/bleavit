...
//! FRAME pallet shell scaffold for the `futarchy-treasury` protocol component.
//!
//! The production runtime-facing wrapper is intentionally thin: all protocol
//! state-transition semantics remain in `futarchy-treasury-core`, which is the differential
