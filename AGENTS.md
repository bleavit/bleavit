...
| `frontend/` | N10 | 10 §10 monorepo with `packages/bleavit-client-ts`, the finalized-proof/PAPI facade for off-chain clients; future `apps/web` and `tools/*` remain unscaffolded |
