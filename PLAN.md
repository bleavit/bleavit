...
**Current: A5 — `pallet-oracle`**. A4 is complete; next up is reporter/watchtower registries, bonded reporting, challenge rounds, reserve probing, and neutral settlement.
