...
contract v23). Four rules govern how those books render, and the design must carry all four: domain
...
drawn as governance participation or protocol health; and the trading and redemption rituals do not
relax. That is a genuine visual-design problem — two co-equal domains, one of which must never be
