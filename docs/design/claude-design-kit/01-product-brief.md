...
| **External client / integrator** | Registers through values governance, funds hosted conditional books, and consumes a provenance-bound price report; its own rule decides what to do | External-book schema is contract v20; hosted question/report surface is v21 authored, not yet in force; no canonical screen assigned |
