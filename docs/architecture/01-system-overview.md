...
| ADR-10 | Ruin-risk gating | Four-market (S,C)×(adopt,reject) set for CODE/META/all TREASURY | D-18: daily breach flags driven by `C_onchain` only (deterministic); gate books exempt from the sanity band |
