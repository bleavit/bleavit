...
| X-11f (T20 event) | §2.1 T20 emits `ProposalForceRejected(ProcessHold)` + ledger `VaultVoided` (event names frozen in [doc 02](./02-integration-contract.md)) |
