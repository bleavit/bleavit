...
- Keeper metered budget 12,000 USDC/epoch. Collator comp 500 USDC/collator/epoch (re-anchored from 2,000, 2026-07-31, SQ-535 — see D-15). Intake: ≤4 entries/epoch/account; 10% bond slash (to INSURANCE — burning USDC would strand backing reserve) on non-decision-grade/preimage-missing outcomes.
