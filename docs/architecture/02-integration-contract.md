...
The crate re-exports `INTEGRATION_CONTRACT_VERSION: u32 = 17`, exposed as a `pallet-constitution` runtime constant (metadata-readable, §9).
...
| Contract version | `INTEGRATION_CONTRACT_VERSION = 17` (runtime constant) |
...
|---|---|---|---|
| Constitution | `INTEGRATION_CONTRACT_VERSION` | `u32` | `futarchy_primitives::INTEGRATION_CONTRACT_VERSION` (= 17) |
