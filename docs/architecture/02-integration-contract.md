...
| Contract version | `INTEGRATION_CONTRACT_VERSION` (runtime constant) — **`28` in force** (§13's history is the authority; read the constant, never a prose copy of it) |
