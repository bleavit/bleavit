...
|---|---|---|---|
| Constitution | `INTEGRATION_CONTRACT_VERSION` | `u32` | `futarchy_primitives::INTEGRATION_CONTRACT_VERSION` (**= 16 in force**; = 17 with the v17 surface, §13) |
...
| ExecutionGuard | `INTEGRATION_CONTRACT_VERSION` | `u32` | `futarchy_primitives::INTEGRATION_CONTRACT_VERSION` (**= 16 in force**; = 17 with the v17 surface, §13) |
...
| Epoch | `INTEGRATION_CONTRACT_VERSION` | `u32` | `futarchy_primitives::INTEGRATION_CONTRACT_VERSION` (**= 16 in force**; = 17 with the v17 surface, §13) |
...
| Welfare | `INTEGRATION_CONTRACT_VERSION` | `u32` | `futarchy_primitives::INTEGRATION_CONTRACT_VERSION` (**= 16 in force**; = 17 with the v17 surface, §13) |
...
| FutarchyTreasury | `INTEGRATION_CONTRACT_VERSION` | `u32` | `futarchy_primitives::INTEGRATION_CONTRACT_VERSION` (**= 16 in force**; = 17 with the v17 surface, §13) |
