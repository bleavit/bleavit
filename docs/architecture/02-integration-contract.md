...
### 7.6 SDK pallet storage the frontend reads (contract v24; SQ-580 · extended v27, SQ-590)
...
| Contract version | `INTEGRATION_CONTRACT_VERSION` (runtime constant) — **`27` in force** (§13's history is the authority; read the constant, never a prose copy of it) |
...
|---|---|
| X-1a | §3–§4a: the complete 14-method `FutarchyApi` with every view type fully defined in `futarchy-primitives`; light-client-callable; P-5/P-7 and D-20 applied and completed |
