...
| S4 | Positions / transfer / redeem (incl. **Voided**) | core | `Positions` prefix / `account_positions()`, `Vaults(pid)`, `BaselineVaults(epoch)` | `ledger.split/merge/split_scalar/merge_scalar/split_gate/merge_gate/transfer/redeem/redeem_scalar/redeem_scalar_pair/redeem_gate/redeem_baseline/redeem_baseline_pair/redeem_void` | §11.5, §11.6 |
