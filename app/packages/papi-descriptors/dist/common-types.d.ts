...
export type I71v2rrt182hod = {
    ...
    "gate_outcomes": FixedSizeArray<2, Anonymize<I8ie0dco0kcuq5>>;
    "spec": number;
};
...
export type Icqilkshp1mtl = {
    ...
    "pre_upgrade_checkpoint"?: (Anonymize<I2ccsdtloqt0h4>) | undefined;
    "cancelled": boolean;
...
export type I3nir9l71btsd5 = Array<{
    ...
    "payload_hash": SizedHex<32>;
    "ask": bigint;
    "decision_market"?: Anonymize<I5vv5n03oo8gas>;
...
export type I3v48tp5484oth = AnonymousEnum<{
    ...
    "Module": Enum<{
        ...
        "AssetsPrecompilesPermit": Anonymize<I5k971batm6ehv>;
...
export type I1hvvfhug26jll = AnonymousEnum<{
    "NotRoot": undefined;
    "NotGateway": undefined;
    "InvalidLiteLabel": undefined;
    "InvalidBaseLabel": undefined;
    "NoActiveReservation": undefined;
    "QueueFull": undefined;
    "AlreadyReserved": undefined;
    "NotHolder": undefined;
}>;
...
export type I29uq5455vq130 = AnonymousEnum<{
    "MintFailed": undefined;
    "ElapsedClamped": {
        "actual_elapsed": bigint;
        "ceiling": bigint;
    };
}>;
...
export type Iq3dapmsriggs = AnonymousEnum<{
    "Any": undefined;
...
export type Ied80rdpusan1f = {
    "pure": SS58String;
    "spawner": SS58String;
    "proxy_type": Anonymize<Iq3dapmsriggs>;
    "disambiguation_index": number;
};
export type I75c7qrsfp7nlg = {
    "delegator": SS58String;
    "delegatee": SS58String;
    "proxy_type": Anonymize<Iq3dapmsriggs>;
    "delay": number;
...
export type I4ivg4grtu56me = AnonymousEnum<{
    ...
    "ValidatorIncentiveWeightMismatch": Anonymize<I9bur6p3ovq9mo>;
    "ValidatorIncentiveTransferFailed": Anonymize<I9bur6p3ovq9mo>;
}>;
export type I9bur6p3ovq9mo = {
    "era": number;
};
export type I6vle0jppq6m24 = {
    "era": number;
    "validator_stash": SS58String;
    "dest": StakingRewardDestination;
    "amount": bigint;
};
export type I545psrfbokuc2 = {
...
export type Id5npe93oclint = AnonymousEnum<{
...
export type I6at0amaqc5r60 = {
    "entity": Anonymize<I4pgs2j4mmb12q>;
};
...
export type I762rjtdaa553f = Array<{
    "id": Enum<{
        "NominationPools": NominationPoolsPalletFreezeReason;
        "Revive": Enum<{
            "PGasMinBalance": undefined;
        }>;
    }>;
    "amount": bigint;
}>;
...
export type Ic2seb0fn4tqs = AnonymousEnum<{
    ...
    "ErasValidatorIncentiveWeight": undefined;
}>;
...
export type Ia1cba3u875b3 = AnonymousEnum<{
    "Inactive": undefined;
    "Active": {
        "initialized_at_sequence": bigint;
    };
    "Terminated": undefined;
}>;
export type I5k86f11ne5gjd = {
    "last_processed_sequence": bigint;
    "last_batch_received_time": bigint;
...
export type Ib5bko2vt0c3eu = {
    "new_allocations": Anonymize<Ib2ccgbk23rsam>;
};
...
export type I5bdpjlmj4phdc = {
    "delegate": MultiAddress;
    "proxy_type": Anonymize<Iq3dapmsriggs>;
    "delay": number;
};
export type Iag45j3iuog165 = {
    "proxy_type": Anonymize<Iq3dapmsriggs>;
    "delay": number;
    "index": number;
};
export type I9fg860lp990m2 = {
    "spawner": MultiAddress;
    "proxy_type": Anonymize<Iq3dapmsriggs>;
    "index": number;
    "height": number;
...
export type Ifej8h55fqfna0 = {
    "optimum_self_stake": StakingPalletConfigOpBig;
    "hard_cap_self_stake": StakingPalletConfigOpBig;
    "self_stake_slope_factor": StakingPalletConfigOp;
};
...
export type Ic2gkpk0orj06b = {
    "slot_index": number;
    "target": SS58String;
};
export type Ip2b8725fmudi = {
    "day_index": number;
...
export type I1dp7qidnaqhcj = AnonymousEnum<{
    "General": Anonymize<I14c8h9js6s0k6>;
    "Era": [number, Anonymize<I14c8h9js6s0k6>];
}>;
export type I14c8h9js6s0k6 = AnonymousEnum<{
    "StakerRewards": undefined;
    "ValidatorSelfStake": undefined;
}>;
export type Iffpbtnc90lulf = {
    "staker_rewards": bigint;
    "validator_incentive": bigint;
};
...
export type I9mq0s1ommikm5 = {
    "timestamp_override"?: Anonymize<I35p85j063s0il>;
    "perform_balance_checks"?: Anonymize<I8ie0dco0kcuq5>;
    "state_overrides"?: Anonymize<Id22r0gklsr0ok>;
};
export type Id22r0gklsr0ok = (Array<[SizedHex<20>, {
    ...
    "storage"?: (Enum<{
        "State": Array<Anonymize<I2ccsdtloqt0h4>>;
        "StateDiff": Array<Anonymize<I2ccsdtloqt0h4>>;
    }>) | undefined;
    "move_precompile_to_address"?: Anonymize<If7b8240vgt2q5>;
}]>) | undefined;
...
export type Ib0ssegjtc3be6 = ResultPayload<{
    "code_hash": SizedHex<32>;
    "deposit": bigint;
}, Anonymize<I3v48tp5484oth>>;
