...
export type Iau1paeqrbp4gi = AnonymousEnum<{ Preimage: PreimagePalletHoldReason; PolkadotXcm: Enum<{ AuthorizeAlias: undefined }>; Session: Enum<{ Keys: undefined }>; Guardian: Enum<{ SeatBond: undefined }>; Attestor: Enum<{ AttestorBond: undefined; ChallengeBond: undefined }>; ClientRegistry: Enum<{ ClientBond: undefined }> }>;
...
export type Ida3u2t8t1l1js = AnonymousEnum<{ Ongoing: { track: number; origin: Anonymize<I8rf10c1lb823v>; proposal: PreimagesBounded; enactment: TraitsScheduleDispatchTime; submitted: number; submission_deposit: Anonymize<Id5fm4p8lj5qgi>; decision_deposit?: Anonymize<Ibd24caul84kv2>; deciding?: { since: number; confirming?: Anonymize<I4arjljr6dpflb> } | undefined; tally: Anonymize<Ifsk7cbmtit1jd>; in_queue: boolean; alarm?: [number, Anonymize<I9jd27rnpm8ttv>] | undefined }; Approved: [number, Anonymize<Ibd24caul84kv2>, Anonymize<Ibd24caul84kv2>]; Rejected: [number, Anonymize<Ibd24caul84kv2>, Anonymize<Ibd24caul84kv2>]; Cancelled: [number, Anonymize<Ibd24caul84kv2>, Anonymize<Ibd24caul84kv2>]; TimedOut: [number, Anonymize<Ibd24caul84kv2>, Anonymize<Ibd24caul84kv2>]; Killed: number }>;
export type I8rf10c1lb823v = AnonymousEnum<{ system: Enum<{ Root: undefined; Signed: SS58String; None: undefined; Authorized: undefined }>; CumulusXcm: Enum<{ Relay: undefined; SiblingParachain: number }>; PolkadotXcm: Enum<{ Xcm: Anonymize<If9iqq7i64mur8>; Response: Anonymize<If9iqq7i64mur8> }>; Origins: Enum<{ FutarchyParam: undefined; FutarchyTreasury: undefined; FutarchyCode: undefined; FutarchyMeta: undefined; ConstitutionalValues: undefined; OracleResolution: undefined; GuardianHold: undefined; EmergencyPlaybook: undefined }>; TrackOrigins: Enum<{ Metric: undefined; Constitution: undefined; Entrenched: undefined; GuardianTrack: undefined; Ratify: undefined }>; ClientRegistry: Enum<{ ExternalClient: number }> }>;
...
export type I5mpbmq1ooiq9i = Array<{ recipient: number; state: Enum<{ Ok: undefined; Suspended: undefined }>; signals_exist: boolean; first_index: number; last_index: number; flags: number; queued_bytes: number }>;
...
export type I71v2rrt182hod = { escrowed: bigint; branches: FixedSizeArray<2, { usdc: bigint; scalar_sets: bigint; gate_sets: Anonymize<I200n1ov5tbcvr> }>; state: Anonymize<I2i509mmosaj3i>; gate_outcomes: FixedSizeArray<2, boolean | undefined>; spec: number };
...
export type Icqilkshp1mtl = { pid: bigint; payload_hash: SizedHex<32>; payload_len: number; class: Anonymize<I2hfnh9jsghgur>; maturity: number; grace_end: number; version_constraint: Anonymize<I8dfqph7nh6ls>; meters_declared: Anonymize<Ia4mcm726srfom>; ratify_ref?: Anonymize<I4arjljr6dpflb>; ratification_passed: boolean; attestation_id?: Anonymize<I4arjljr6dpflb>; pre_upgrade_checkpoint?: FixedSizeArray<2, SizedHex<32>> | undefined; cancelled: boolean; declared_domains: Array<Enum<{ Public: undefined; Param: undefined; Treasury: undefined; Code: undefined; Meta: undefined; InternalRootAuthorizeUpgrade: undefined; InternalRootApplyUpgrade: undefined }>>; failed_at?: Anonymize<I4arjljr6dpflb> };
...
export type I3nir9l71btsd5 = Array<{ id: bigint; class: Anonymize<I2hfnh9jsghgur>; state: Anonymize<I4jen3q60pp5qd>; proposer: SizedHex<32>; epoch: number; payload_hash: SizedHex<32>; ask: bigint; decision_market?: Anonymize<I200n1ov5tbcvr> | undefined; gate_markets?: Anonymize<Ic4rgfgksgmm3e>; decide_at: number; maturity?: Anonymize<I4arjljr6dpflb>; ratification: Anonymize<I1pb9rgjl7sl5l>; funder: SizedHex<32> }>;
