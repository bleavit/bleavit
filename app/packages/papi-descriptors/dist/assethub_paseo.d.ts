...
type IStorage = {
  System: {
     ...
     */
    Events: StorageDescriptor<[], Anonymize<Ieqt7n1rf1k69o>, false, never>;
    /**
  ...
  Scheduler: {
     ...
     */
    Agenda: StorageDescriptor<[Key: number], Anonymize<I226kqgcfgo790>, false, never>;
    /**
  ...
  Balances: {
     ...
     */
    Freezes: StorageDescriptor<[Key: SS58String], Anonymize<I762rjtdaa553f>, false, never>;
  };
  TransactionPayment: {
    /**
  ...
  Proxy: {
     ...
     */
    Proxies: StorageDescriptor<[Key: SS58String], Anonymize<Iag7gka4fmp5er>, false, never>;
    /**
  ...
  AssetsFreezer: {
     ...
     */
    Freezes: StorageDescriptor<Anonymize<I7svnfko10tq2e>, Anonymize<I762rjtdaa553f>, false, never>;
    /**
  ...
  AssetsHolder: {
     ...
     */
    Holds: StorageDescriptor<Anonymize<I7svnfko10tq2e>, Anonymize<I3a3gt3bf28qh7>, false, never>;
    /**
  ...
  Referenda: {
     ...
     */
    ReferendumInfoFor: StorageDescriptor<[Key: number], Anonymize<Icqb8vu2svfhjf>, true, never>;
    /**
  ...
  MembersSubscriber: {
     ...
     */
    RingRoots: StorageDescriptor<Anonymize<I4pact7n2e9a0i>, Anonymize<Ic05hka01p7c4i>, true, never>;
    /**
     * State of each ring collection including rings count and missing rings tracking.
     */
    RingCollectionStates: StorageDescriptor<[Key: SizedHex<32>], Anonymize<I7varcg4klvmsf>, false, never>;
    /**
     ...
     */
    RingCollectionExponents: StorageDescriptor<[Key: SizedHex<32>], Anonymize<Idvob66qflhcgd>, true, never>;
    /**
     * Current subscription status.
     */
    Subscription: StorageDescriptor<[], Anonymize<Ia1cba3u875b3>, false, never>;
    /**
     * State for tracking updates processing timestamps and sequence numbers.
     */
    ProcessingState: StorageDescriptor<[], Anonymize<I5k86f11ne5gjd>, false, never>;
  };
  AliasAccounts: {
    /**
     ...
     */
    AliasToAccount: StorageDescriptor<Anonymize<I8g5kqku53c190>, SS58String, true, never>;
    /**
     * Maps account to full alias info (collection + revised contextual alias).
     */
    AccountToAlias: StorageDescriptor<[Key: SS58String], Anonymize<Ia892jrs62vldc>, true, never>;
    /**
     ...
     */
    AliasFee: StorageDescriptor<[], bigint, true, never>;
  };
  Pgas: {
    /**
     ...
     * without scanning.
     */
    ClaimedGasAliases: StorageDescriptor<Anonymize<I9jea06984vfti>, null, true, never>;
  };
  Revive: {
    /**
  ...
  DotnsGateway: {
     ...
     */
    AliasRegistration: StorageDescriptor<[Key: SizedHex<32>], Anonymize<If85gvv84rc1b>, true, never>;
    /**
     ...
     */
    AccountAlias: StorageDescriptor<[Key: SS58String], SizedHex<32>, true, never>;
    /**
     ...
     */
    LiteLabelOwner: StorageDescriptor<[Key: Uint8Array], SS58String, true, never>;
    /**
     ...
     */
    DispatcherAddress: StorageDescriptor<[], SizedHex<20>, true, never>;
  };
  OriginRestriction: {
    /**
     * The current usage for each entity.
     */
    Usages: StorageDescriptor<[Key: Anonymize<I4pgs2j4mmb12q>], Anonymize<Icj0tssrh6ika3>, true, never>;
  };
  Sudo: {
    /**
...
type ICalls = {
  ...
  Scheduler: {
     ...
     */
    schedule: TxDescriptor<Anonymize<I4eopdufa5bdk8>>;
    /**
     ...
     */
    schedule_named: TxDescriptor<Anonymize<I8hg4d5q2ltark>>;
    /**
     ...
     */
    schedule_after: TxDescriptor<Anonymize<Ictcdoi96smosi>>;
    /**
     * Schedule a named task after a delay.
     */
    schedule_named_after: TxDescriptor<Anonymize<I3ttr0gem35mdu>>;
    /**
  ...
  Utility: {
     ...
     * event is deposited.
     */
    batch: TxDescriptor<Anonymize<I5lbr40m04ak69>>;
    /**
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    as_derivative: TxDescriptor<Anonymize<I7ns2a9oeu8be5>>;
    /**
     ...
     * - O(C) where C is the number of calls to be batched.
     */
    batch_all: TxDescriptor<Anonymize<I5lbr40m04ak69>>;
    /**
     ...
     * - O(1).
     */
    dispatch_as: TxDescriptor<Anonymize<I3fpug2dld0r8m>>;
    /**
     * Send a batch of dispatch calls.
     ...
     * - O(C) where C is the number of calls to be batched.
     */
    force_batch: TxDescriptor<Anonymize<I5lbr40m04ak69>>;
    /**
     ...
     * The dispatch origin for this call must be _Root_.
     */
    with_weight: TxDescriptor<Anonymize<I9ram4dti7vvhv>>;
    /**
     ...
     * or both.
     */
    if_else: TxDescriptor<Anonymize<I46jf39pgs2u4u>>;
    /**
     * Dispatches a function call with a provided origin.
     *
     ...
     * The dispatch origin for this call must be _Root_.
     */
    dispatch_as_fallible: TxDescriptor<Anonymize<I3fpug2dld0r8m>>;
  };
  Multisig: {
    /**
     ...
     */
    as_multi_threshold_1: TxDescriptor<Anonymize<I4hhm3djmaqhk9>>;
    /**
     ...
     */
    as_multi: TxDescriptor<Anonymize<If5d5vd5s3hom0>>;
    /**
     * Register approval for a dispatch to be made from a deterministic composite account if
     * approved by a total of `threshold - 1` of `other_signatories`.
     *
  ...
  Proxy: {
     ...
     */
    proxy: TxDescriptor<Anonymize<I31mtbkbio2383>>;
    /**
     ...
     * zero.
     */
    add_proxy: TxDescriptor<Anonymize<I5bdpjlmj4phdc>>;
    /**
     ...
     */
    remove_proxy: TxDescriptor<Anonymize<I5bdpjlmj4phdc>>;
    /**
     ...
     */
    create_pure: TxDescriptor<Anonymize<Iag45j3iuog165>>;
    /**
     ...
     */
    kill_pure: TxDescriptor<Anonymize<I9fg860lp990m2>>;
    /**
     ...
     * - `call`: The call to be made by the `real` account.
     */
    proxy_announced: TxDescriptor<Anonymize<Idbiu3ka7qdu81>>;
    /**
  ...
  Referenda: {
     ...
     * Emits `Submitted`.
     */
    submit: TxDescriptor<Anonymize<I9qsaa39akt3b6>>;
    /**
  ...
  Whitelist: {
    ...
    /**
         ...
         */
    dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<Ifacok17cvls3n>>;
  };
  Bounties: {
    /**
  ...
  MembersSubscriber: {
     ...
     */
    initialize_ring_roots: TxDescriptor<Anonymize<I9p75jqdr4nh7f>>;
    /**
     ...
     */
    process_ring_updates: TxDescriptor<Anonymize<I6k8blge6b41eq>>;
    /**
     ...
     */
    terminate_subscription: TxDescriptor<undefined>;
    /**
     ...
     */
    replay_missing_roots: TxDescriptor<Anonymize<Icec749qc1mpna>>;
  };
  AliasAccounts: {
    /**
     ...
     */
    set_alias_account: TxDescriptor<Anonymize<Iab0nqc372eia>>;
    /**
     ...
     */
    reprove_alias_account: TxDescriptor<Anonymize<I6fhhpo0k6s6lr>>;
    /**
     ...
     */
    set_alias_fee: TxDescriptor<Anonymize<Ib1ilbm5ipoh62>>;
    /**
     ...
     */
    clean_up_stale_alias: TxDescriptor<Anonymize<Ieu5ttli9tg91>>;
  };
  Pgas: {
    /**
     ...
     */
    claim_pgas: TxDescriptor<Anonymize<Ic2gkpk0orj06b>>;
    /**
     ...
     */
    create_pgas_asset: TxDescriptor<undefined>;
    /**
     ...
     */
    clean_pgas_claim_records: TxDescriptor<Anonymize<Ip2b8725fmudi>>;
  };
  Revive: {
    /**
     ...
     */
    eth_substrate_call: TxDescriptor<Anonymize<I4tgnabqehk6na>>;
    /**
     ...
     */
    batch_map_accounts: TxDescriptor<Anonymize<I9gel4bv68gacj>>;
    /**
     ...
     */
    dispatch_as_fallback_account: TxDescriptor<Anonymize<Ifacok17cvls3n>>;
  };
  DotnsGateway: {
    /**
     ...
     */
    reserve_name: TxDescriptor<Anonymize<I1hdbgb10envte>>;
    /**
     ...
     */
    register_name: TxDescriptor<Anonymize<I9ov5hft672si3>>;
    /**
     ...
     */
    set_dispatcher_address: TxDescriptor<Anonymize<Itmchvgqfl28g>>;
  };
  OriginRestriction: {
    /**
     ...
     */
    clean_usage: TxDescriptor<Anonymize<I6at0amaqc5r60>>;
  };
  Sudo: {
    /**
     * Authenticates the sudo key and dispatches a function call with `Root` origin.
     */
    sudo: TxDescriptor<Anonymize<Ifacok17cvls3n>>;
    /**
     * Authenticates the sudo key and dispatches a function call with `Root` origin.
     * This function does not check the weight of the call, and instead allows the
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    sudo_unchecked_weight: TxDescriptor<Anonymize<I9ram4dti7vvhv>>;
    /**
     ...
     * The dispatch origin for this call must be _Signed_.
     */
    sudo_as: TxDescriptor<Anonymize<I862edtjk8h9ij>>;
    /**
...
type IEvent = {
  System: {
     ...
     * An extrinsic failed.
     */
    ExtrinsicFailed: PlainDescriptor<Anonymize<Idkvkmmgbl8jne>>;
    /**
     ...
     */
    TaskFailed: PlainDescriptor<Anonymize<Ibu47iareat2vc>>;
    /**
     ...
     */
    RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<Ifk6r39afdvu7e>>;
  };
  ParachainSystem: {
    /**
  ...
  Scheduler: {
     ...
     */
    Dispatched: PlainDescriptor<Anonymize<Iajap7qjb6bmus>>;
    /**
  ...
  Utility: {
     ...
     * well as the error.
     */
    BatchInterrupted: PlainDescriptor<Anonymize<Ifuhste1ebchgv>>;
    /**
     ...
     */
    ItemFailed: PlainDescriptor<Anonymize<I3bbd4ih1sm5rk>>;
    /**
     * A call was dispatched.
     */
    DispatchedAs: PlainDescriptor<Anonymize<Ifue5tr1igffke>>;
    /**
     ...
     */
    IfElseFallbackCalled: PlainDescriptor<Anonymize<I522m86k6ln5ak>>;
  };
  Multisig: {
    /**
     ...
     */
    MultisigExecuted: PlainDescriptor<Anonymize<Ibl41shttdjev9>>;
    /**
  ...
  Proxy: {
     ...
     */
    ProxyExecuted: PlainDescriptor<Anonymize<Ifue5tr1igffke>>;
    /**
     * A pure account has been created by new proxy with given
     * disambiguation index and proxy type.
     */
    PureCreated: PlainDescriptor<Anonymize<I4dt3661bsu4r4>>;
    /**
     * A pure proxy was killed by its spawner.
     */
    PureKilled: PlainDescriptor<Anonymize<Ied80rdpusan1f>>;
    /**
     ...
     * A proxy was added.
     */
    ProxyAdded: PlainDescriptor<Anonymize<I75c7qrsfp7nlg>>;
    /**
     * A proxy was removed.
     */
    ProxyRemoved: PlainDescriptor<Anonymize<I75c7qrsfp7nlg>>;
    /**
  ...
  AssetsHolder: {
     ...
     */
    Held: PlainDescriptor<Anonymize<I17i7j1j46bce3>>;
    /**
     * `who`s balance on hold was decreased by `amount`.
     */
    Released: PlainDescriptor<Anonymize<I17i7j1j46bce3>>;
    /**
     * `who`s balance on hold was burned by `amount`.
     */
    Burned: PlainDescriptor<Anonymize<I17i7j1j46bce3>>;
  };
  Treasury: {
    /**
  ...
  Whitelist: {
    ...
    /**
         ...
         */
    WhitelistedCallDispatched: PlainDescriptor<Anonymize<I8bo1tpr9a8c2h>>;
  };
  Bounties: {
    /**
     * New bounty proposal.
  ...
  MembersSubscriber: {
     ...
     */
    RingRootsInitialized: PlainDescriptor<Anonymize<I37mpns1l5dsq>>;
    /**
     * Ring root updates have been processed.
     */
    RingRootsUpdated: PlainDescriptor<Anonymize<I37mpns1l5dsq>>;
    /**
     * Subscription has been terminated.
     */
    SubscriptionTerminated: PlainDescriptor<Anonymize<I41otkavempbl>>;
    /**
     * New missing ring roots detected during batch processing.
     */
    MissingRingsDetected: PlainDescriptor<Anonymize<Ij28ljhcuk0a1>>;
    /**
     * Replay request successfully sent to notifier.
     */
    ReplayRequestSent: PlainDescriptor<Anonymize<Ibd55ljc5eg0ot>>;
    /**
     * Missing ring scan skipped because deleted_indices reached capacity.
     */
    DeletedIndicesAtCapacity: PlainDescriptor<Anonymize<Idjiu7vp8ovdab>>;
  };
  AliasAccounts: {
    /**
     * An alias account has been set or updated.
     */
    AliasAccountSet: PlainDescriptor<Anonymize<I2k5q8tu497vml>>;
    /**
     * An alias account has been removed.
     */
    AliasAccountUnset: PlainDescriptor<Anonymize<Icbccs0ug47ilf>>;
    /**
     * A stale alias mapping was cleaned up.
     */
    StaleAliasCleanedUp: PlainDescriptor<Anonymize<I2k5q8tu497vml>>;
    /**
     * The PGAS fee for alias registrations was changed.
     */
    AliasFeeSet: PlainDescriptor<Anonymize<Ib1ilbm5ipoh62>>;
  };
  Pgas: {
    /**
     * PGAS was claimed by a person.
     */
    PgasClaimed: PlainDescriptor<Anonymize<I3v5hj167gg0lm>>;
    /**
     * The PGAS asset was created.
     */
    PgasAssetCreated: PlainDescriptor<undefined>;
    /**
     * Old PGAS claim records were cleaned up.
     */
    PgasClaimRecordsCleaned: PlainDescriptor<Anonymize<Iav577o5q7lojg>>;
  };
  Revive: {
    /**
     ...
     */
    EthExtrinsicRevert: PlainDescriptor<Anonymize<Itqt1ijla4vha>>;
  };
  DotnsGateway: {
    /**
     * A username has been reserved for a candidate by an attester.
     */
    NameReserved: PlainDescriptor<Anonymize<I139g3ciecrt3g>>;
    /**
     * A username has been registered by a verified person.
     */
    NameRegistered: PlainDescriptor<Anonymize<I5oke0ng9d28gs>>;
    /**
     ...
     */
    AllAttestationAllowanceCleared: PlainDescriptor<Anonymize<Ifph6tiih28159>>;
    /**
     * The `RootGatewayDispatcher` contract address was set.
     */
    DispatcherAddressSet: PlainDescriptor<Anonymize<Itmchvgqfl28g>>;
  };
  OriginRestriction: {
    /**
     * Usage for an entity is cleaned.
     */
    UsageCleaned: PlainDescriptor<Anonymize<I6at0amaqc5r60>>;
  };
  Sudo: {
    /**
     * A sudo call just took place.
     */
    Sudid: PlainDescriptor<Anonymize<I255irfn84gpvv>>;
    /**
     ...
     */
    SudoAsDone: PlainDescriptor<Anonymize<I255irfn84gpvv>>;
  };
  PgasAllowance: {
    /**
...
type IError = {
  ...
  MembersSubscriber: {
     ...
     */
    SubscriptionInactive: PlainDescriptor<undefined>;
    /**
     * Subscription is in terminated state.
     */
    SubscriptionTerminated: PlainDescriptor<undefined>;
    /**
     * Subscription is active with a different sequence; must be terminated first.
     */
    SubscriptionAlreadyActive: PlainDescriptor<undefined>;
    /**
     ...
     */
    RevisionNotFound: PlainDescriptor<undefined>;
  };
  AliasAccounts: {
    /**
     * The collection is not accepted.
     */
    InvalidCollection: PlainDescriptor<undefined>;
    /**
     ...
     */
    InvalidRingCapacity: PlainDescriptor<undefined>;
  };
  Pgas: {
    /**
...
type IConstants = {
  ...
  MembersSubscriber: {
     ...
     */
    RingRootsNotifier: PlainDescriptor<Anonymize<If0d1j56sjc2vd>>;
    /**
     ...
     */
    ReplayWarningThreshold: PlainDescriptor<number>;
    /**
     ...
     */
    ReplayAbandonThreshold: PlainDescriptor<number>;
    /**
     ...
     */
    MaxRecentRootsPerRing: PlainDescriptor<number>;
    /**
  ...
  AliasAccounts: {
     ...
     */
    ProofValidityWindow: PlainDescriptor<bigint>;
    /**
     ...
     * Must be greater than zero.
     */
    CleanupGracePeriod: PlainDescriptor<bigint>;
    /**
     * Ring exponent for People Lite.
     */
    PeopleLiteRingExponent: PlainDescriptor<Anonymize<Idvob66qflhcgd>>;
    /**
     * Ring exponent for People.
     */
    PeopleRingExponent: PlainDescriptor<Anonymize<Idvob66qflhcgd>>;
    /**
  ...
  Pgas: {
     ...
     */
    PgasAssetId: PlainDescriptor<number>;
    /**
     * The amount of PGAS minted per claim.
     */
    PgasClaimAmount: PlainDescriptor<bigint>;
    /**
     * Maximum number of PGAS claims a full person may perform per period (day).
     */
    MaxClaimsPerPeriodPerPerson: PlainDescriptor<number>;
    /**
     ...
     */
    MaxClaimsPerPeriodPerLitePerson: PlainDescriptor<number>;
    /**
     * Maximum number of PGAS claim records that can be cleaned up in a single call.
     */
    MaxPgasClaimRecordCleanupPerCall: PlainDescriptor<number>;
  };
  Revive: {
    /**
  ...
  DotnsGateway: {
     ...
     */
    MaxContractCallWeight: PlainDescriptor<Anonymize<I4q39t5hn830vp>>;
    /**
     * Signature validity window, in seconds.
     * A signature is accepted only if `now <= signed_at + MaxValiditySeconds`.
     */
    MaxValiditySeconds: PlainDescriptor<bigint>;
    /**
...
type IViewFns = {
  ...
  Proxy: {
     ...
     */
    check_permissions: RuntimeDescriptor<[call: Anonymize<Iag8b7oglutv48>, proxy_type: Anonymize<Iq3dapmsriggs>], boolean>;
    /**
...
type IRuntimeCalls = {
  ...
  BlockBuilder: {
     ...
     * this block or not.
     */
    apply_extrinsic: RuntimeDescriptor<[extrinsic: Uint8Array], Anonymize<Idp0ot5sj4l28h>>;
    /**
  ...
  TransactionPaymentCallApi: {
     ...
     */
    query_call_info: RuntimeDescriptor<[call: Anonymize<Iag8b7oglutv48>, len: number], Anonymize<I6spmpef2c7svf>>;
    /**
     * Query fee details of a given encoded `Call`.
     */
    query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Iag8b7oglutv48>, len: number], Anonymize<Iei2mvq0mjvt81>>;
    /**
  ...
  DryRunApi: {
     ...
     * Dry run call V2.
     */
    dry_run_call: RuntimeDescriptor<[origin: Anonymize<I16fdh28nbfp7t>, call: Anonymize<Iag8b7oglutv48>, result_xcms_version: number], Anonymize<Ic32osvq328s8t>>;
    /**
     * Dry run XCM program
     */
    dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I8l4l0329bukfi>>;
  };
  /**
  ...
  ReviveApi: {
     ...
     */
    call: RuntimeDescriptor<[origin: SS58String, dest: SizedHex<20>, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, input_data: Uint8Array], Anonymize<Iaruiltgfqb5g1>>;
    /**
     * Instantiate a new contract.
     *
     * See `[crate::Pallet::bare_instantiate]`.
     */
    instantiate: RuntimeDescriptor<[origin: SS58String, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, code: Anonymize<I9sijb8gfrns29>, data: Uint8Array, salt: Anonymize<I4s6vifaf8k998>], Anonymize<I8mk4egnd52l3v>>;
    /**
     ...
     */
    upload_code: RuntimeDescriptor<[origin: SS58String, code: Uint8Array, storage_deposit_limit: Anonymize<I35p85j063s0il>], Anonymize<Ib0ssegjtc3be6>>;
    /**
     ...
     */
    get_storage: RuntimeDescriptor<[address: SizedHex<20>, key: SizedHex<32>], Anonymize<Idi8u55mdv7qd1>>;
    /**
     ...
     * doesn't exist, or doesn't have a contract then `Err` is returned.
     */
    get_storage_var_key: RuntimeDescriptor<[address: SizedHex<20>, key: Uint8Array], Anonymize<Idi8u55mdv7qd1>>;
    /**
...
export type Assethub_paseoDispatchError = Anonymize<I3v48tp5484oth>;
type IAsset = PlainDescriptor<Anonymize<If9iqq7i64mur8>>;
export type Assethub_paseoExtensions = { AuthorizeValueTransfer: { value: Anonymize<I40k710moo3ghm> }; AsPgas: { value: Anonymize<I1uglf8pvj966e> }; AsRingAlias: { value: Anonymize<Ibde2kn6a3h6jg> }; AsDotnsGateway: { value: Anonymize<I1rcvckb8i5tcv> }; RestrictOrigins: { value: boolean } };
type PalletsTypedef = { __storage: IStorage; __tx: ICalls; __event: IEvent; __error: IError; __const: IConstants; __view: IViewFns };
export type Assethub_paseo = { descriptors: { pallets: PalletsTypedef; apis: IRuntimeCalls } & Promise<any>; metadataTypes: Promise<Uint8Array>; asset: IAsset; extensions: Assethub_paseoExtensions; getMetadata: () => Promise<Uint8Array>; genesis: string | undefined };
declare const _allDescriptors: Assethub_paseo;
export default _allDescriptors;
export type Assethub_paseoApis = ApisFromDef<IRuntimeCalls>;
export type Assethub_paseoQueries = QueryFromPalletsDef<PalletsTypedef>;
export type Assethub_paseoCalls = TxFromPalletsDef<PalletsTypedef>;
export type Assethub_paseoEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Assethub_paseoErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Assethub_paseoConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Assethub_paseoViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Assethub_paseoCallData = Anonymize<Iag8b7oglutv48> & { value: { type: string } };
type AllInteractions = { storage: { System: ["Account", "ExtrinsicCount", "InherentsApplied", "BlockWeight", "BlockSize", "BlockHash", "ExtrinsicData", "Number", "ParentHash", "Digest", "Events", "EventCount", "EventTopics", "LastRuntimeUpgrade", "BlocksTillUpgrade", "UpgradedToU32RefCount", "UpgradedToTripleRefCount", "ExecutionPhase", "AuthorizedUpgrade", "ExtrinsicWeightReclaimed"]; ParachainSystem: ["BlockWeightMode", "PreviousCoreCount", "UnincludedSegment", "AggregatedUnincludedSegment", "PendingValidationCode", "NewValidationCode", "ValidationData", "DidSetValidationCode", "LastRelayChainBlockNumber", "UpgradeRestrictionSignal", "UpgradeGoAhead", "RelayStateProof", "RelevantMessagingState", "HostConfiguration", "LastDmqMqcHead", "LastHrmpMqcHeads", "ProcessedDownwardMessages", "LastProcessedDownwardMessage", "HrmpWatermark", "LastProcessedHrmpMessage", "HrmpOutboundMessages", "UpwardMessages", "PendingUpwardMessages", "PendingUpwardSignals", "PendingApprovedPeer", "UpwardDeliveryFeeFactor", "AnnouncedHrmpMessagesPerCandidate", "ReservedXcmpWeightOverride", "ReservedDmpWeightOverride", "CustomValidationHeadData", "PoVMessagesTracker"]; Timestamp: ["Now", "DidUpdate"]; ParachainInfo: ["ParachainId"]; Preimage: ["StatusFor", "RequestStatusFor", "PreimageFor"]; Scheduler: ["IncompleteSince", "Agenda", "Retries", "Lookup"]; Parameters: ["Parameters"]; MultiBlockMigrations: ["Cursor", "Historic"]; Balances: ["TotalIssuance", "InactiveIssuance", "Account", "Locks", "Reserves", "Holds", "Freezes"]; TransactionPayment: ["NextFeeMultiplier", "StorageVersion", "TxPaymentCredit"]; Vesting: ["Vesting", "StorageVersion"]; Claims: ["Claims", "Total", "Vesting", "Signing", "Preclaims"]; Dap: ["BudgetAllocation", "LastIssuanceTimestamp"]; Authorship: ["Author"]; CollatorSelection: ["Invulnerables", "CandidateList", "LastAuthoredBlock", "DesiredCandidates", "CandidacyBond"]; Session: ["Validators", "CurrentIndex", "QueuedChanged", "QueuedKeys", "DisabledValidators", "NextKeys", "KeyOwner", "ExternallySetKeys"]; Aura: ["Authorities", "CurrentSlot"]; AuraExt: ["Authorities", "RelaySlotInfo"]; XcmpQueue: ["InboundXcmpSuspended", "OutboundXcmpStatus", "OutboundXcmpMessages", "SignalMessages", "QueueConfig", "QueueSuspended", "DeliveryFeeFactor"]; PolkadotXcm: ["QueryCounter", "Queries", "AssetTraps", "SafeXcmVersion", "SupportedVersion", "VersionNotifiers", "VersionNotifyTargets", "VersionDiscoveryQueue", "CurrentMigration", "RemoteLockedFungibles", "LockedFungibles", "XcmExecutionSuspended", "ShouldRecordXcm", "RecordedXcm", "AuthorizedAliases"]; ToKusamaXcmRouter: ["Bridge"]; MessageQueue: ["BookStateFor", "ServiceHead", "Pages"]; SnowbridgeSystemFrontend: ["ExportOperatingMode"]; Multisig: ["Multisigs"]; Proxy: ["Proxies", "Announcements"]; Indices: ["Accounts"]; Assets: ["Asset", "Account", "Approvals", "Metadata", "Reserves", "NextAssetId"]; Uniques: ["Class", "OwnershipAcceptance", "Account", "ClassAccount", "Asset", "ClassMetadataOf", "InstanceMetadataOf", "Attribute", "ItemPriceOf", "CollectionMaxSupply"]; Nfts: ["Collection", "OwnershipAcceptance", "Account", "CollectionAccount", "CollectionRoleOf", "Item", "CollectionMetadataOf", "ItemMetadataOf", "Attribute", "ItemPriceOf", "ItemAttributesApprovalsOf", "NextCollectionId", "PendingSwapOf", "CollectionConfigOf", "ItemConfigOf"]; ForeignAssets: ["Asset", "Account", "Approvals", "Metadata", "Reserves", "NextAssetId"]; PoolAssets: ["Asset", "Account", "Approvals", "Metadata", "Reserves", "NextAssetId"]; AssetConversion: ["Pools", "NextPoolAssetId"]; AssetsFreezer: ["Freezes", "FrozenBalances"]; AssetsHolder: ["Holds", "BalancesOnHold"]; Treasury: ["ProposalCount", "Proposals", "Deactivated", "Approvals", "SpendCount", "Spends", "LastSpendPeriod"]; ConvictionVoting: ["VotingFor", "ClassLocksFor"]; Referenda: ["ReferendumCount", "ReferendumInfoFor", "TrackQueue", "DecidingCount", "MetadataOf"]; Whitelist: ["WhitelistedCall"]; Bounties: ["BountyCount", "Bounties", "BountyDescriptions", "BountyApprovals"]; ChildBounties: ["ChildBountyCount", "ParentChildBounties", "ParentTotalChildBounties", "ChildBounties", "ChildBountyDescriptionsV1", "V0ToV1ChildBountyIds", "ChildrenCuratorFees"]; AssetRate: ["ConversionRateToNative"]; MultiAssetBounties: ["BountyCount", "Bounties", "ChildBounties", "ChildBountiesPerParent", "TotalChildBountiesPerParent", "ChildBountiesValuePerParent", "CuratorDeposit"]; StateTrieMigration: ["MigrationProcess", "AutoLimits", "SignedMigrationMaxLimits"]; NominationPools: ["TotalValueLocked", "MinJoinBond", "MinCreateBond", "MaxPools", "MaxPoolMembers", "MaxPoolMembersPerPool", "GlobalMaxCommission", "PoolMembers", "CounterForPoolMembers", "BondedPools", "CounterForBondedPools", "RewardPools", "CounterForRewardPools", "SubPoolsStorage", "CounterForSubPoolsStorage", "Metadata", "CounterForMetadata", "LastPoolId", "ReversePoolIdLookup", "CounterForReversePoolIdLookup", "ClaimPermissions"]; VoterList: ["ListNodes", "CounterForListNodes", "ListBags", "NextNodeAutoRebagged", "Lock", "PendingRebag", "CounterForPendingRebag"]; DelegatedStaking: ["Delegators", "CounterForDelegators", "Agents", "CounterForAgents"]; StakingRcClient: ["IncompleteSessionReport", "LastSessionReportEndingIndex", "OutgoingValidatorSet"]; MultiBlockElection: ["Round", "CurrentPhase", "DesiredTargets", "PagedVoterSnapshot", "PagedVoterSnapshotHash", "PagedTargetSnapshot", "PagedTargetSnapshotHash"]; MultiBlockElectionVerifier: ["QueuedSolutionX", "QueuedSolutionY", "QueuedValidVariant", "QueuedSolutionBackings", "QueuedSolutionScore", "MinimumScore", "StatusStorage"]; MultiBlockElectionSigned: ["Invulnerables", "SortedScores", "SubmissionStorage", "SubmissionMetadataStorage"]; Staking: ["ValidatorCount", "Bonded", "MinNominatorBond", "MinValidatorBond", "MinimumActiveStake", "MinCommission", "MaxCommission", "DisableMintingGuard", "OptimumSelfStake", "HardCapSelfStake", "SelfStakeSlopeFactor", "ErasValidatorIncentiveBudget", "ErasSumValidatorIncentiveWeight", "ErasValidatorIncentiveWeight", "AreNominatorsSlashable", "ErasNominatorsSlashable", "Ledger", "Payee", "Validators", "CounterForValidators", "MaxValidatorsCount", "LastValidatorEra", "Nominators", "CounterForNominators", "VirtualStakers", "CounterForVirtualStakers", "MaxNominatorsCount", "CurrentEra", "ActiveEra", "BondedEras", "ErasStakersOverview", "ErasStakersPaged", "ClaimedRewards", "ErasValidatorPrefs", "ErasValidatorReward", "ErasRewardPoints", "ErasTotalStake", "ForceEra", "MaxStakedRewards", "SlashRewardFraction", "CanceledSlashPayout", "OffenceQueue", "OffenceQueueEras", "ProcessingOffence", "UnappliedSlashes", "CancelledSlashes", "ValidatorSlashInEra", "ChillThreshold", "VoterSnapshotStatus", "NextElectionPage", "ElectableStashes", "EraPruningState"]; MembersSubscriber: ["RingRoots", "RingCollectionStates", "RingCollectionExponents", "Subscription", "ProcessingState"]; AliasAccounts: ["AliasToAccount", "AccountToAlias", "AliasFee"]; Pgas: ["ClaimedGasAliases"]; Revive: ["PristineCode", "CodeInfoOf", "AccountInfoOf", "NativeDepositOf", "ImmutableDataOf", "DeletionQueue", "DeletionQueueCounter", "OriginalAccount", "EthereumBlock", "BlockHash", "ReceiptInfoData", "EthBlockBuilderIR", "EthBlockBuilderFirstValues", "DebugSettingsOf"]; AssetsPrecompiles: ["NextAssetIndex", "AssetIndexToForeignAssetId", "ForeignAssetIdToAssetIndex"]; AssetsPrecompilesPermit: ["Nonces"]; DotnsGateway: ["AliasRegistration", "AccountAlias", "AttestationAllowance", "LiteLabelOwner", "DispatcherAddress"]; OriginRestriction: ["Usages"]; Sudo: ["Key"]; AhOps: ["RcLeaseReserve", "RcCrowdloanContribution", "RcCrowdloanReserve"] }; tx: { System: ["remark", "set_heap_pages", "set_code", "set_code_without_checks", "set_storage", "kill_storage", "kill_prefix", "remark_with_event", "do_task", "authorize_upgrade", "authorize_upgrade_without_checks", "apply_authorized_upgrade"]; ParachainSystem: ["set_validation_data", "sudo_send_upward_message"]; Timestamp: ["set"]; Preimage: ["note_preimage", "unnote_preimage", "request_preimage", "unrequest_preimage", "ensure_updated"]; Scheduler: ["schedule", "cancel", "schedule_named", "cancel_named", "schedule_after", "schedule_named_after", "set_retry", "set_retry_named", "cancel_retry", "cancel_retry_named"]; Parameters: ["set_parameter"]; MultiBlockMigrations: ["force_set_cursor", "force_set_active_cursor", "force_onboard_mbms", "clear_historic"]; Balances: ["transfer_allow_death", "force_transfer", "transfer_keep_alive", "transfer_all", "force_unreserve", "upgrade_accounts", "force_set_balance", "force_adjust_total_issuance", "burn"]; Vesting: ["vest", "vest_other", "vested_transfer", "force_vested_transfer", "merge_schedules", "force_remove_vesting_schedule"]; Claims: ["claim", "mint_claim", "claim_attest", "attest", "move_claim"]; Dap: ["set_budget_allocation"]; CollatorSelection: ["set_invulnerables", "set_desired_candidates", "set_candidacy_bond", "register_as_candidate", "leave_intent", "add_invulnerable", "remove_invulnerable", "update_bond", "take_candidate_slot"]; Session: ["set_keys", "purge_keys"]; XcmpQueue: ["suspend_xcm_execution", "resume_xcm_execution", "update_suspend_threshold", "update_drop_threshold", "update_resume_threshold"]; PolkadotXcm: ["send", "teleport_assets", "reserve_transfer_assets", "execute", "force_xcm_version", "force_default_xcm_version", "force_subscribe_version_notify", "force_unsubscribe_version_notify", "limited_reserve_transfer_assets", "limited_teleport_assets", "force_suspension", "transfer_assets", "claim_assets", "transfer_assets_using_type_and_then", "add_authorized_alias", "remove_authorized_alias", "remove_all_authorized_aliases"]; ToKusamaXcmRouter: ["report_bridge_status"]; MessageQueue: ["reap_page", "execute_overweight"]; SnowbridgeSystemFrontend: ["set_operating_mode", "register_token", "add_tip"]; Utility: ["batch", "as_derivative", "batch_all", "dispatch_as", "force_batch", "with_weight", "if_else", "dispatch_as_fallible"]; Multisig: ["as_multi_threshold_1", "as_multi", "approve_as_multi", "cancel_as_multi", "poke_deposit"]; Proxy: ["proxy", "add_proxy", "remove_proxy", "remove_proxies", "create_pure", "kill_pure", "announce", "remove_announcement", "reject_announcement", "proxy_announced", "poke_deposit"]; Indices: ["claim", "transfer", "free", "force_transfer", "freeze", "poke_deposit"]; Assets: ["create", "force_create", "start_destroy", "destroy_accounts", "destroy_approvals", "finish_destroy", "mint", "burn", "transfer", "transfer_keep_alive", "force_transfer", "freeze", "thaw", "freeze_asset", "thaw_asset", "transfer_ownership", "set_team", "set_metadata", "clear_metadata", "force_set_metadata", "force_clear_metadata", "force_asset_status", "approve_transfer", "cancel_approval", "force_cancel_approval", "transfer_approved", "touch", "refund", "set_min_balance", "touch_other", "refund_other", "block", "transfer_all", "set_reserves"]; Uniques: ["create", "force_create", "destroy", "mint", "burn", "transfer", "redeposit", "freeze", "thaw", "freeze_collection", "thaw_collection", "transfer_ownership", "set_team", "approve_transfer", "cancel_approval", "force_item_status", "set_attribute", "clear_attribute", "set_metadata", "clear_metadata", "set_collection_metadata", "clear_collection_metadata", "set_accept_ownership", "set_collection_max_supply", "set_price", "buy_item"]; Nfts: ["create", "force_create", "destroy", "mint", "force_mint", "burn", "transfer", "redeposit", "lock_item_transfer", "unlock_item_transfer", "lock_collection", "transfer_ownership", "set_team", "force_collection_owner", "force_collection_config", "approve_transfer", "cancel_approval", "clear_all_transfer_approvals", "lock_item_properties", "set_attribute", "force_set_attribute", "clear_attribute", "approve_item_attributes", "cancel_item_attributes_approval", "set_metadata", "clear_metadata", "set_collection_metadata", "clear_collection_metadata", "set_accept_ownership", "set_collection_max_supply", "update_mint_settings", "set_price", "buy_item", "pay_tips", "create_swap", "cancel_swap", "claim_swap", "mint_pre_signed", "set_attributes_pre_signed"]; ForeignAssets: ["create", "force_create", "start_destroy", "destroy_accounts", "destroy_approvals", "finish_destroy", "mint", "burn", "transfer", "transfer_keep_alive", "force_transfer", "freeze", "thaw", "freeze_asset", "thaw_asset", "transfer_ownership", "set_team", "set_metadata", "clear_metadata", "force_set_metadata", "force_clear_metadata", "force_asset_status", "approve_transfer", "cancel_approval", "force_cancel_approval", "transfer_approved", "touch", "refund", "set_min_balance", "touch_other", "refund_other", "block", "transfer_all", "set_reserves"]; PoolAssets: ["create", "force_create", "start_destroy", "destroy_accounts", "destroy_approvals", "finish_destroy", "mint", "burn", "transfer", "transfer_keep_alive", "force_transfer", "freeze", "thaw", "freeze_asset", "thaw_asset", "transfer_ownership", "set_team", "set_metadata", "clear_metadata", "force_set_metadata", "force_clear_metadata", "force_asset_status", "approve_transfer", "cancel_approval", "force_cancel_approval", "transfer_approved", "touch", "refund", "set_min_balance", "touch_other", "refund_other", "block", "transfer_all", "set_reserves"]; AssetConversion: ["create_pool", "add_liquidity", "remove_liquidity", "swap_exact_tokens_for_tokens", "swap_tokens_for_exact_tokens", "touch"]; Treasury: ["spend_local", "remove_approval", "spend", "payout", "check_status", "void_spend"]; ConvictionVoting: ["vote", "delegate", "undelegate", "unlock", "remove_vote", "remove_other_vote"]; Referenda: ["submit", "place_decision_deposit", "refund_decision_deposit", "cancel", "kill", "nudge_referendum", "one_fewer_deciding", "refund_submission_deposit", "set_metadata"]; Whitelist: ["whitelist_call", "remove_whitelisted_call", "dispatch_whitelisted_call", "dispatch_whitelisted_call_with_preimage"]; Bounties: ["propose_bounty", "approve_bounty", "propose_curator", "unassign_curator", "accept_curator", "award_bounty", "claim_bounty", "close_bounty", "extend_bounty_expiry", "approve_bounty_with_curator", "poke_deposit"]; ChildBounties: ["add_child_bounty", "propose_curator", "accept_curator", "unassign_curator", "award_child_bounty", "claim_child_bounty", "close_child_bounty"]; AssetRate: ["create", "update", "remove"]; MultiAssetBounties: ["fund_bounty", "fund_child_bounty", "propose_curator", "accept_curator", "unassign_curator", "award_bounty", "close_bounty", "check_status", "retry_payment"]; StateTrieMigration: ["control_auto_migration", "continue_migrate", "migrate_custom_top", "migrate_custom_child", "set_signed_max_limits", "force_set_progress"]; NominationPools: ["join", "bond_extra", "claim_payout", "unbond", "pool_withdraw_unbonded", "withdraw_unbonded", "create", "create_with_pool_id", "nominate", "set_state", "set_metadata", "set_configs", "update_roles", "chill", "bond_extra_other", "set_claim_permission", "claim_payout_other", "set_commission", "set_commission_max", "set_commission_change_rate", "claim_commission", "adjust_pool_deposit", "set_commission_claim_permission", "apply_slash", "migrate_delegation", "migrate_pool_to_delegate_stake"]; VoterList: ["rebag", "put_in_front_of", "put_in_front_of_other"]; StakingRcClient: ["relay_session_report", "relay_new_offence_paged", "set_keys", "purge_keys"]; MultiBlockElection: ["manage", "admin"]; MultiBlockElectionUnsigned: ["submit_unsigned"]; MultiBlockElectionSigned: ["register", "submit_page", "bail", "clear_old_round_data", "set_invulnerables"]; Staking: ["bond", "bond_extra", "unbond", "withdraw_unbonded", "validate", "nominate", "chill", "set_payee", "set_controller", "set_validator_count", "increase_validator_count", "scale_validator_count", "force_no_eras", "force_new_era", "force_unstake", "force_new_era_always", "cancel_deferred_slash", "payout_stakers", "rebond", "reap_stash", "kick", "set_staking_configs", "chill_other", "force_apply_min_commission", "set_min_commission", "payout_stakers_by_page", "update_payee", "deprecate_controller_batch", "restore_ledger", "migrate_currency", "apply_slash", "prune_era_step", "set_max_commission", "set_validator_self_stake_incentive_config"]; MembersSubscriber: ["initialize_ring_roots", "process_ring_updates", "terminate_subscription", "replay_missing_roots"]; AliasAccounts: ["unset_alias_account", "set_alias_account", "reprove_alias_account", "set_alias_fee", "clean_up_stale_alias"]; Pgas: ["claim_pgas", "create_pgas_asset", "clean_pgas_claim_records"]; Revive: ["eth_transact", "call", "instantiate", "instantiate_with_code", "eth_instantiate_with_code", "eth_call", "eth_substrate_call", "upload_code", "remove_code", "set_code", "map_account", "batch_map_accounts", "unmap_account", "dispatch_as_fallback_account"]; DotnsGateway: ["reserve_name", "register_name", "increase_attestation_allowance", "clear_attestation_allowance", "set_dispatcher_address"]; OriginRestriction: ["clean_usage"]; Sudo: ["sudo", "sudo_unchecked_weight", "set_key", "sudo_as", "remove_key"]; AhOps: ["unreserve_lease_deposit", "withdraw_crowdloan_contribution", "unreserve_crowdloan_reserve", "transfer_to_post_migration_treasury", "translate_para_sovereign_child_to_sibling_derived"] }; events: { System: ["ExtrinsicSuccess", "ExtrinsicFailed", "CodeUpdated", "NewAccount", "KilledAccount", "Remarked", "TaskStarted", "TaskCompleted", "TaskFailed", "UpgradeAuthorized", "RejectedInvalidAuthorizedUpgrade"]; ParachainSystem: ["ValidationFunctionStored", "ValidationFunctionApplied", "ValidationFunctionDiscarded", "DownwardMessagesReceived", "DownwardMessagesProcessed", "UpwardMessageSent"]; Preimage: ["Noted", "Requested", "Cleared"]; Scheduler: ["Scheduled", "Canceled", "Dispatched", "RetrySet", "RetryCancelled", "CallUnavailable", "PeriodicFailed", "RetryFailed", "PermanentlyOverweight", "AgendaIncomplete"]; Parameters: ["Updated"]; MultiBlockMigrations: ["UpgradeStarted", "UpgradeCompleted", "UpgradeFailed", "MigrationSkipped", "MigrationAdvanced", "MigrationCompleted", "MigrationFailed", "HistoricCleared"]; Balances: ["Endowed", "DustLost", "Transfer", "BalanceSet", "Reserved", "Unreserved", "ReserveRepatriated", "Deposit", "Withdraw", "Slashed", "Minted", "MintedCredit", "Burned", "BurnedDebt", "Suspended", "Restored", "Upgraded", "Issued", "Rescinded", "Locked", "Unlocked", "Frozen", "Thawed", "TotalIssuanceForced", "Held", "BurnedHeld", "TransferOnHold", "TransferAndHold", "Released", "Unexpected"]; TransactionPayment: ["TransactionFeePaid"]; AssetTxPayment: ["AssetTxFeePaid", "AssetRefundFailed"]; Vesting: ["VestingCreated", "VestingUpdated", "VestingCompleted"]; Claims: ["Claimed"]; Dap: ["IssuanceMinted", "BudgetAllocationUpdated", "StagingDrained", "Unexpected"]; CollatorSelection: ["NewInvulnerables", "InvulnerableAdded", "InvulnerableRemoved", "NewDesiredCandidates", "NewCandidacyBond", "CandidateAdded", "CandidateBondUpdated", "CandidateRemoved", "CandidateReplaced", "InvalidInvulnerableSkipped"]; Session: ["NewSession", "NewQueued", "ValidatorDisabled", "ValidatorReenabled"]; XcmpQueue: ["XcmpMessageSent"]; PolkadotXcm: ["Attempted", "Sent", "SendFailed", "ProcessXcmError", "UnexpectedResponse", "ResponseReady", "Notified", "NotifyOverweight", "NotifyDispatchError", "NotifyDecodeFailed", "InvalidResponder", "InvalidResponderVersion", "ResponseTaken", "AssetsTrapped", "VersionChangeNotified", "SupportedVersionChanged", "NotifyTargetSendFail", "NotifyTargetMigrationFail", "InvalidQuerierVersion", "InvalidQuerier", "VersionNotifyStarted", "VersionNotifyRequested", "VersionNotifyUnrequested", "FeesPaid", "AssetsClaimed", "VersionMigrationFinished", "AliasAuthorized", "AliasAuthorizationRemoved", "AliasesAuthorizationsRemoved"]; CumulusXcm: ["InvalidFormat", "UnsupportedVersion", "ExecutedDownward"]; ToKusamaXcmRouter: ["DeliveryFeeFactorDecreased", "DeliveryFeeFactorIncreased"]; MessageQueue: ["ProcessingFailed", "Processed", "OverweightEnqueued", "PageReaped"]; SnowbridgeSystemFrontend: ["MessageSent", "ExportOperatingModeChanged"]; Utility: ["BatchInterrupted", "BatchCompleted", "BatchCompletedWithErrors", "ItemCompleted", "ItemFailed", "DispatchedAs", "IfElseMainSuccess", "IfElseFallbackCalled"]; Multisig: ["NewMultisig", "MultisigApproval", "MultisigExecuted", "MultisigCancelled", "DepositPoked"]; Proxy: ["ProxyExecuted", "PureCreated", "PureKilled", "Announced", "ProxyAdded", "ProxyRemoved", "DepositPoked"]; Indices: ["IndexAssigned", "IndexFreed", "IndexFrozen", "DepositPoked"]; Assets: ["Created", "Issued", "Transferred", "Burned", "TeamChanged", "OwnerChanged", "Frozen", "Thawed", "AssetFrozen", "AssetThawed", "AccountsDestroyed", "ApprovalsDestroyed", "DestructionStarted", "Destroyed", "ForceCreated", "MetadataSet", "MetadataCleared", "ApprovedTransfer", "ApprovalCancelled", "TransferredApproved", "AssetStatusChanged", "AssetMinBalanceChanged", "Touched", "Blocked", "Deposited", "Withdrawn", "ReservesUpdated", "ReservesRemoved", "IssuedCredit", "BurnedCredit", "IssuedDebt", "BurnedDebt"]; Uniques: ["Created", "ForceCreated", "Destroyed", "Issued", "Transferred", "Burned", "Frozen", "Thawed", "CollectionFrozen", "CollectionThawed", "OwnerChanged", "TeamChanged", "ApprovedTransfer", "ApprovalCancelled", "ItemStatusChanged", "CollectionMetadataSet", "CollectionMetadataCleared", "MetadataSet", "MetadataCleared", "Redeposited", "AttributeSet", "AttributeCleared", "OwnershipAcceptanceChanged", "CollectionMaxSupplySet", "ItemPriceSet", "ItemPriceRemoved", "ItemBought"]; Nfts: ["Created", "ForceCreated", "Destroyed", "Issued", "Transferred", "Burned", "ItemTransferLocked", "ItemTransferUnlocked", "ItemPropertiesLocked", "CollectionLocked", "OwnerChanged", "TeamChanged", "TransferApproved", "ApprovalCancelled", "AllApprovalsCancelled", "CollectionConfigChanged", "CollectionMetadataSet", "CollectionMetadataCleared", "ItemMetadataSet", "ItemMetadataCleared", "Redeposited", "AttributeSet", "AttributeCleared", "ItemAttributesApprovalAdded", "ItemAttributesApprovalRemoved", "OwnershipAcceptanceChanged", "CollectionMaxSupplySet", "CollectionMintSettingsUpdated", "NextCollectionIdIncremented", "ItemPriceSet", "ItemPriceRemoved", "ItemBought", "TipSent", "SwapCreated", "SwapCancelled", "SwapClaimed", "PreSignedAttributesSet", "PalletAttributeSet"]; ForeignAssets: ["Created", "Issued", "Transferred", "Burned", "TeamChanged", "OwnerChanged", "Frozen", "Thawed", "AssetFrozen", "AssetThawed", "AccountsDestroyed", "ApprovalsDestroyed", "DestructionStarted", "Destroyed", "ForceCreated", "MetadataSet", "MetadataCleared", "ApprovedTransfer", "ApprovalCancelled", "TransferredApproved", "AssetStatusChanged", "AssetMinBalanceChanged", "Touched", "Blocked", "Deposited", "Withdrawn", "ReservesUpdated", "ReservesRemoved", "IssuedCredit", "BurnedCredit", "IssuedDebt", "BurnedDebt"]; PoolAssets: ["Created", "Issued", "Transferred", "Burned", "TeamChanged", "OwnerChanged", "Frozen", "Thawed", "AssetFrozen", "AssetThawed", "AccountsDestroyed", "ApprovalsDestroyed", "DestructionStarted", "Destroyed", "ForceCreated", "MetadataSet", "MetadataCleared", "ApprovedTransfer", "ApprovalCancelled", "TransferredApproved", "AssetStatusChanged", "AssetMinBalanceChanged", "Touched", "Blocked", "Deposited", "Withdrawn", "ReservesUpdated", "ReservesRemoved", "IssuedCredit", "BurnedCredit", "IssuedDebt", "BurnedDebt"]; AssetConversion: ["PoolCreated", "LiquidityAdded", "LiquidityRemoved", "SwapExecuted", "SwapCreditExecuted", "Touched"]; AssetsFreezer: ["Frozen", "Thawed"]; AssetsHolder: ["Held", "Released", "Burned"]; Treasury: ["Spending", "Awarded", "Burnt", "Rollover", "Deposit", "SpendApproved", "UpdatedInactive", "AssetSpendApproved", "AssetSpendVoided", "Paid", "PaymentFailed", "SpendProcessed"]; ConvictionVoting: ["Delegated", "Undelegated", "Voted", "VoteRemoved", "VoteUnlocked"]; Referenda: ["Submitted", "DecisionDepositPlaced", "DecisionDepositRefunded", "DepositSlashed", "DecisionStarted", "ConfirmStarted", "ConfirmAborted", "Confirmed", "Approved", "Rejected", "TimedOut", "Cancelled", "Killed", "SubmissionDepositRefunded", "MetadataSet", "MetadataCleared"]; Whitelist: ["CallWhitelisted", "WhitelistedCallRemoved", "WhitelistedCallDispatched"]; Bounties: ["BountyProposed", "BountyRejected", "BountyBecameActive", "BountyAwarded", "BountyClaimed", "BountyCanceled", "BountyExtended", "BountyApproved", "CuratorProposed", "CuratorUnassigned", "CuratorAccepted", "DepositPoked"]; ChildBounties: ["Added", "Awarded", "Claimed", "Canceled"]; AssetRate: ["AssetRateCreated", "AssetRateRemoved", "AssetRateUpdated"]; MultiAssetBounties: ["BountyCreated", "ChildBountyCreated", "BountyBecameActive", "BountyAwarded", "BountyPayoutProcessed", "BountyFundingProcessed", "BountyRefundProcessed", "BountyCanceled", "CuratorUnassigned", "CuratorProposed", "PaymentFailed", "Paid"]; StateTrieMigration: ["Migrated", "Slashed", "AutoMigrationFinished", "Halted"]; NominationPools: ["Created", "Bonded", "PaidOut", "Unbonded", "Withdrawn", "Destroyed", "StateChanged", "MemberRemoved", "RolesUpdated", "PoolSlashed", "UnbondingPoolSlashed", "PoolCommissionUpdated", "PoolMaxCommissionUpdated", "PoolCommissionChangeRateUpdated", "PoolCommissionClaimPermissionUpdated", "PoolCommissionClaimed", "MinBalanceDeficitAdjusted", "MinBalanceExcessAdjusted", "MemberClaimPermissionUpdated", "MetadataUpdated", "PoolNominationMade", "PoolNominatorChilled", "GlobalParamsUpdated"]; VoterList: ["Rebagged", "ScoreUpdated"]; DelegatedStaking: ["Delegated", "Released", "Slashed", "MigratedDelegation"]; StakingRcClient: ["SessionReportReceived", "OffenceReceived", "FeesPaid", "Unexpected"]; MultiBlockElection: ["PhaseTransitioned", "UnexpectedTargetSnapshotFailed", "UnexpectedVoterSnapshotFailed", "UnexpectedPhaseTransitionOutOfWeight", "UnexpectedPhaseTransitionHalt"]; MultiBlockElectionVerifier: ["VerificationFailed", "Verified", "Queued"]; MultiBlockElectionSigned: ["Registered", "Stored", "Rewarded", "Slashed", "Ejected", "Discarded", "Bailed"]; Staking: ["EraPaid", "Rewarded", "Slashed", "OldSlashingReportDiscarded", "Bonded", "Unbonded", "Withdrawn", "StakerRemoved", "Kicked", "Chilled", "PayoutStarted", "ValidatorPrefsSet", "SnapshotVotersSizeExceeded", "SnapshotTargetsSizeExceeded", "ForceEra", "ControllerBatchDeprecated", "CurrencyMigrated", "PagedElectionProceeded", "OffenceReported", "SlashComputed", "SlashCancelled", "SessionRotated", "Unexpected", "OffenceTooOld", "EraPruned", "ValidatorIncentivePaid", "ValidatorIncentiveConfigSet"]; MembersSubscriber: ["RingRootsInitialized", "RingRootsUpdated", "SubscriptionTerminated", "MissingRingsDetected", "ReplayRequestSent", "DeletedIndicesAtCapacity"]; AliasAccounts: ["AliasAccountSet", "AliasAccountUnset", "StaleAliasCleanedUp", "AliasFeeSet"]; Pgas: ["PgasClaimed", "PgasAssetCreated", "PgasClaimRecordsCleaned"]; Revive: ["ContractEmitted", "Instantiated", "EthExtrinsicRevert"]; DotnsGateway: ["NameReserved", "NameRegistered", "AttestationAllowanceIncreased", "AllAttestationAllowanceCleared", "DispatcherAddressSet"]; OriginRestriction: ["UsageCleaned"]; Sudo: ["Sudid", "KeyChanged", "KeyRemoved", "SudoAsDone"]; PgasAllowance: ["PGASFeePaid"]; AhOps: ["LeaseUnreserveRemaining", "CrowdloanUnreserveRemaining", "SovereignMigrated", "FailedToBond"] }; errors: { System: ["InvalidSpecName", "SpecVersionNeedsToIncrease", "FailedToExtractRuntimeVersion", "NonDefaultComposite", "NonZeroRefCount", "CallFiltered", "MultiBlockMigrationsOngoing", "InvalidTask", "FailedTask", "NothingAuthorized", "Unauthorized"]; ParachainSystem: ["OverlappingUpgrades", "ProhibitedByPolkadot", "TooBig", "ValidationDataNotAvailable", "HostConfigurationNotAvailable", "NotScheduled"]; Preimage: ["TooBig", "AlreadyNoted", "NotAuthorized", "NotNoted", "Requested", "NotRequested", "TooMany", "TooFew"]; Scheduler: ["FailedToSchedule", "NotFound", "TargetBlockNumberInPast", "RescheduleNoChange", "Named"]; MultiBlockMigrations: ["Ongoing"]; Balances: ["VestingBalance", "LiquidityRestrictions", "InsufficientBalance", "ExistentialDeposit", "Expendability", "ExistingVestingSchedule", "DeadAccount", "TooManyReserves", "TooManyHolds", "TooManyFreezes", "IssuanceDeactivated", "DeltaZero"]; Vesting: ["NotVesting", "AtMaxVestingSchedules", "AmountLow", "ScheduleIndexOutOfBounds", "InvalidScheduleParams"]; Claims: ["InvalidEthereumSignature", "SignerHasNoClaim", "SenderHasNoClaim", "PotUnderflow", "InvalidStatement", "VestedBalanceExists"]; Dap: ["UnknownBudgetKey", "BudgetNotExact"]; CollatorSelection: ["TooManyCandidates", "TooFewEligibleCollators", "AlreadyCandidate", "NotCandidate", "TooManyInvulnerables", "AlreadyInvulnerable", "NotInvulnerable", "NoAssociatedValidatorId", "ValidatorNotRegistered", "InsertToCandidateListFailed", "RemoveFromCandidateListFailed", "DepositTooLow", "UpdateCandidateListFailed", "InsufficientBond", "TargetIsNotCandidate", "IdenticalDeposit", "InvalidUnreserve"]; Session: ["InvalidProof", "NoAssociatedValidatorId", "DuplicatedKey", "NoKeys", "NoAccount"]; XcmpQueue: ["BadQueueConfig", "AlreadySuspended", "AlreadyResumed", "TooManyActiveOutboundChannels", "TooBig"]; PolkadotXcm: ["Unreachable", "SendFailure", "Filtered", "UnweighableMessage", "DestinationNotInvertible", "Empty", "CannotReanchor", "TooManyAssets", "InvalidOrigin", "BadVersion", "BadLocation", "NoSubscription", "AlreadySubscribed", "CannotCheckOutTeleport", "LowBalance", "TooManyLocks", "AccountNotSovereign", "FeesNotMet", "LockNotFound", "InUse", "InvalidAssetUnknownReserve", "InvalidAssetUnsupportedReserve", "TooManyReserves", "LocalExecutionIncomplete", "TooManyAuthorizedAliases", "ExpiresInPast", "AliasNotFound", "LocalExecutionIncompleteWithError"]; MessageQueue: ["NotReapable", "NoPage", "NoMessage", "AlreadyProcessed", "Queued", "InsufficientWeight", "TemporarilyUnprocessable", "QueuePaused", "RecursiveDisallowed"]; SnowbridgeSystemFrontend: ["UnsupportedLocationVersion", "InvalidAssetOwner", "SendFailure", "FeesNotMet", "LocationConversionFailed", "Halted", "Unreachable", "UnsupportedAsset", "WithdrawError", "InvalidAccount", "SwapError", "BurnError", "TipAmountZero"]; Utility: ["TooManyCalls"]; Multisig: ["MinimumThreshold", "AlreadyApproved", "NoApprovalsNeeded", "TooFewSignatories", "TooManySignatories", "SignatoriesOutOfOrder", "SenderInSignatories", "NotFound", "NotOwner", "NoTimepoint", "WrongTimepoint", "UnexpectedTimepoint", "MaxWeightTooLow", "AlreadyStored"]; Proxy: ["TooMany", "NotFound", "NotProxy", "Unproxyable", "Duplicate", "NoPermission", "Unannounced", "NoSelfProxy"]; Indices: ["NotAssigned", "NotOwner", "InUse", "NotTransfer", "Permanent"]; Assets: ["BalanceLow", "NoAccount", "NoPermission", "Unknown", "Frozen", "InUse", "BadWitness", "MinBalanceZero", "UnavailableConsumer", "BadMetadata", "Unapproved", "WouldDie", "AlreadyExists", "NoDeposit", "WouldBurn", "LiveAsset", "AssetNotLive", "IncorrectStatus", "NotFrozen", "CallbackFailed", "BadAssetId", "ContainsFreezes", "ContainsHolds", "TooManyReserves"]; Uniques: ["NoPermission", "UnknownCollection", "AlreadyExists", "WrongOwner", "BadWitness", "InUse", "Frozen", "WrongDelegate", "NoDelegate", "Unapproved", "Unaccepted", "Locked", "MaxSupplyReached", "MaxSupplyAlreadySet", "MaxSupplyTooSmall", "UnknownItem", "NotForSale", "BidTooLow", "NoMetadata", "WrongMetadata", "AttributeNotFound", "WrongAttribute"]; Nfts: ["NoPermission", "UnknownCollection", "AlreadyExists", "ApprovalExpired", "WrongOwner", "BadWitness", "CollectionIdInUse", "ItemsNonTransferable", "NotDelegate", "WrongDelegate", "Unapproved", "Unaccepted", "ItemLocked", "LockedItemAttributes", "LockedCollectionAttributes", "LockedItemMetadata", "LockedCollectionMetadata", "MaxSupplyReached", "MaxSupplyLocked", "MaxSupplyTooSmall", "UnknownItem", "UnknownSwap", "MetadataNotFound", "AttributeNotFound", "NotForSale", "BidTooLow", "ReachedApprovalLimit", "DeadlineExpired", "WrongDuration", "MethodDisabled", "WrongSetting", "InconsistentItemConfig", "NoConfig", "RolesNotCleared", "MintNotStarted", "MintEnded", "AlreadyClaimed", "IncorrectData", "WrongOrigin", "WrongSignature", "IncorrectMetadata", "MaxAttributesLimitReached", "WrongNamespace", "CollectionNotEmpty", "WitnessRequired"]; ForeignAssets: ["BalanceLow", "NoAccount", "NoPermission", "Unknown", "Frozen", "InUse", "BadWitness", "MinBalanceZero", "UnavailableConsumer", "BadMetadata", "Unapproved", "WouldDie", "AlreadyExists", "NoDeposit", "WouldBurn", "LiveAsset", "AssetNotLive", "IncorrectStatus", "NotFrozen", "CallbackFailed", "BadAssetId", "ContainsFreezes", "ContainsHolds", "TooManyReserves"]; PoolAssets: ["BalanceLow", "NoAccount", "NoPermission", "Unknown", "Frozen", "InUse", "BadWitness", "MinBalanceZero", "UnavailableConsumer", "BadMetadata", "Unapproved", "WouldDie", "AlreadyExists", "NoDeposit", "WouldBurn", "LiveAsset", "AssetNotLive", "IncorrectStatus", "NotFrozen", "CallbackFailed", "BadAssetId", "ContainsFreezes", "ContainsHolds", "TooManyReserves"]; AssetConversion: ["InvalidAssetPair", "PoolExists", "WrongDesiredAmount", "AmountOneLessThanMinimal", "AmountTwoLessThanMinimal", "ReserveLeftLessThanMinimal", "AmountOutTooHigh", "PoolNotFound", "Overflow", "AssetOneDepositDidNotMeetMinimum", "AssetTwoDepositDidNotMeetMinimum", "AssetOneWithdrawalDidNotMeetMinimum", "AssetTwoWithdrawalDidNotMeetMinimum", "OptimalAmountLessThanDesired", "InsufficientLiquidityMinted", "ZeroLiquidity", "ZeroAmount", "ProvidedMinimumNotSufficientForSwap", "ProvidedMaximumNotSufficientForSwap", "InvalidPath", "NonUniquePath", "IncorrectPoolAssetId", "BelowMinimum", "PoolEmpty"]; AssetsFreezer: ["TooManyFreezes"]; AssetsHolder: ["TooManyHolds"]; Treasury: ["InvalidIndex", "TooManyApprovals", "InsufficientPermission", "ProposalNotApproved", "FailedToConvertBalance", "SpendExpired", "EarlyPayout", "AlreadyAttempted", "PayoutError", "NotAttempted", "Inconclusive"]; ConvictionVoting: ["NotOngoing", "NotVoter", "NoPermission", "NoPermissionYet", "AlreadyDelegating", "AlreadyVoting", "InsufficientFunds", "NotDelegating", "Nonsense", "MaxVotesReached", "ClassNeeded", "BadClass"]; Referenda: ["NotOngoing", "HasDeposit", "BadTrack", "Full", "QueueEmpty", "BadReferendum", "NothingToDo", "NoTrack", "Unfinished", "NoPermission", "NoDeposit", "BadStatus", "PreimageNotExist", "PreimageStoredWithDifferentLength"]; Whitelist: ["UnavailablePreImage", "UndecodableCall", "InvalidCallWeightWitness", "CallIsNotWhitelisted", "CallAlreadyWhitelisted"]; Bounties: ["InsufficientProposersBalance", "InvalidIndex", "ReasonTooBig", "UnexpectedStatus", "RequireCurator", "InvalidValue", "InvalidFee", "PendingPayout", "Premature", "HasActiveChildBounty", "TooManyQueued", "NotProposer"]; ChildBounties: ["ParentBountyNotActive", "InsufficientBountyBalance", "TooManyChildBounties"]; AssetRate: ["UnknownAssetKind", "AlreadyExists", "Overflow"]; MultiAssetBounties: ["InvalidIndex", "ReasonTooBig", "InvalidValue", "FailedToConvertBalance", "UnexpectedStatus", "RequireCurator", "InsufficientPermission", "FundingError", "RefundError", "PayoutError", "FundingInconclusive", "RefundInconclusive", "PayoutInconclusive", "FailedToConvertSource", "HasActiveChildBounty", "TooManyChildBounties", "InsufficientBountyValue", "PreimageNotExist"]; StateTrieMigration: ["MaxSignedLimits", "KeyTooLong", "NotEnoughFunds", "BadWitness", "SignedMigrationNotAllowed", "BadChildRoot"]; NominationPools: ["PoolNotFound", "PoolMemberNotFound", "RewardPoolNotFound", "SubPoolsNotFound", "AccountBelongsToOtherPool", "FullyUnbonding", "MaxUnbondingLimit", "CannotWithdrawAny", "MinimumBondNotMet", "OverflowRisk", "NotDestroying", "NotNominator", "NotKickerOrDestroying", "NotOpen", "MaxPools", "MaxPoolMembers", "CanNotChangeState", "DoesNotHavePermission", "MetadataExceedsMaxLen", "Defensive", "PartialUnbondNotAllowedPermissionlessly", "MaxCommissionRestricted", "CommissionExceedsMaximum", "CommissionExceedsGlobalMaximum", "CommissionChangeThrottled", "CommissionChangeRateNotAllowed", "NoPendingCommission", "NoCommissionCurrentSet", "PoolIdInUse", "InvalidPoolId", "BondExtraRestricted", "NothingToAdjust", "NothingToSlash", "SlashTooLow", "AlreadyMigrated", "NotMigrated", "NotSupported", "Restricted"]; VoterList: ["List", "Locked"]; DelegatedStaking: ["NotAllowed", "AlreadyStaking", "InvalidRewardDestination", "InvalidDelegation", "NotEnoughFunds", "NotAgent", "NotDelegator", "BadState", "UnappliedSlash", "NothingToSlash", "WithdrawFailed", "NotSupported"]; StakingRcClient: ["XcmSendFailed", "NotValidator", "InvalidKeys", "InvalidProof", "FeesExceededMax"]; MultiBlockElection: ["Fallback", "UnexpectedPhase", "Snapshot"]; MultiBlockElectionSigned: ["PhaseNotSigned", "Duplicate", "QueueFull", "BadPageIndex", "NotRegistered", "NoSubmission", "RoundNotOver", "BadWitnessData", "TooManyInvulnerables"]; Staking: ["NotController", "NotStash", "AlreadyBonded", "AlreadyPaired", "EmptyTargets", "DuplicateIndex", "InvalidSlashRecord", "InsufficientBond", "NoMoreChunks", "NoUnlockChunk", "FundedTarget", "InvalidEraToReward", "InvalidNumberOfNominations", "AlreadyClaimed", "InvalidPage", "IncorrectHistoryDepth", "BadState", "TooManyTargets", "BadTarget", "CannotChillOther", "TooManyNominators", "TooManyValidators", "CommissionTooLow", "BoundNotMet", "ControllerDeprecated", "CannotRestoreLedger", "RewardDestinationRestricted", "NotEnoughFunds", "VirtualStakerNotAllowed", "CannotReapStash", "AlreadyMigrated", "EraNotStarted", "Restricted", "UnappliedSlashesInPreviousEra", "EraNotPrunable", "CancelledSlash", "CommissionTooHigh", "OptimumGreaterThanCap"]; MembersSubscriber: ["XcmSendFailed", "SubscriptionInactive", "SubscriptionTerminated", "SubscriptionAlreadyActive", "CollectionNotFound", "NoRoot", "InvalidProof", "InvalidRingExponent", "RevisionNotFound"]; AliasAccounts: ["InvalidCollection", "AccountInUse", "InvalidAccount", "AliasAccountAlreadySet", "TimeOutOfRange", "AliasNotStale", "CleanupTooEarly", "InconsistentState", "AliasFeeUnset", "ReproveMismatch", "RingRootNotFound", "StaleRevision", "BadProof", "InvalidRingCapacity"]; Pgas: ["AlreadyClaimed", "PgasMintFailed", "NoRecordsForDay", "FirstAliasMismatch"]; Revive: ["InvalidSchedule", "InvalidCallFlags", "OutOfGas", "TransferFailed", "MaxCallDepthReached", "ContractNotFound", "CodeNotFound", "CodeInfoNotFound", "OutOfBounds", "DecodingFailed", "ContractTrapped", "ValueTooLarge", "TerminatedWhileReentrant", "InputForwarded", "TooManyTopics", "DuplicateContract", "TerminatedInConstructor", "ReentranceDenied", "ReenteredPallet", "StateChangeDenied", "StorageDepositNotEnoughFunds", "StorageDepositLimitExhausted", "CodeInUse", "ContractReverted", "CodeRejected", "BlobTooLarge", "StaticMemoryTooLarge", "BasicBlockTooLarge", "InvalidInstruction", "MaxDelegateDependenciesReached", "DelegateDependencyNotFound", "DelegateDependencyAlreadyExists", "CannotAddSelfAsDelegateDependency", "OutOfTransientStorage", "InvalidSyscall", "InvalidStorageFlags", "ExecutionFailed", "BalanceConversionFailed", "InvalidImmutableAccess", "AccountUnmapped", "AccountAlreadyMapped", "InvalidGenericTransaction", "RefcountOverOrUnderflow", "UnsupportedPrecompileAddress", "CallDataTooLarge", "ReturnDataTooLarge", "InvalidJump", "StackUnderflow", "StackOverflow", "TxFeeOverdraw", "EvmConstructorNonEmptyData", "EvmConstructedFromHash", "StorageRefundNotEnoughFunds", "StorageRefundLocked", "PrecompileDelegateDenied", "EcdsaRecoveryFailed", "AutoMappingEnabled", "PendingDepositCleanup"]; AssetsPrecompilesPermit: ["InvalidSignature", "SignerMismatch", "PermitExpired", "SignatureSValueTooHigh", "InvalidVValue", "NonceOverflow", "InvalidOwner", "InvalidSpender"]; DotnsGateway: ["AlreadyRegistered", "ContractCallFailed", "ContractRevert", "InvalidName", "NoAttestationAllowance", "InvalidAttestationSignature", "ReservationSignatureExpired", "ReservationSignatureFromFuture", "NotLiteLabelOwner", "DispatcherAddressNotSet"]; OriginRestriction: ["NoUsage", "NotZero"]; Sudo: ["RequireSudo"]; AhOps: ["NoLeaseReserve", "NoCrowdloanContribution", "NoCrowdloanReserve", "FailedToWithdrawCrowdloanContribution", "NotYet", "ContributionsRemaining", "WrongDerivedTranslation", "NotSovereign", "InternalError", "MigrationNotCompleted", "ZeroBalance", "FailedToTransfer", "AlreadyTranslated", "TooLongDerivationPath", "FailedToForceUnstake"] }; constants: { System: ["BlockWeights", "BlockLength", "BlockHashCount", "DbWeight", "Version", "SS58Prefix"]; ParachainSystem: ["SelfParaId"]; Timestamp: ["MinimumPeriod"]; Scheduler: ["MaximumWeight", "MaxScheduledPerBlock"]; MultiBlockMigrations: ["CursorMaxLen", "IdentifierMaxLen"]; Balances: ["ExistentialDeposit", "MaxLocks", "MaxReserves", "MaxFreezes"]; TransactionPayment: ["OperationalFeeMultiplier"]; Vesting: ["MinVestedTransfer", "MaxVestingSchedules"]; Claims: ["Prefix"]; Dap: ["PalletId", "IssuanceCadence", "MaxElapsedPerDrip"]; CollatorSelection: ["PotId", "MaxCandidates", "MinEligibleCollators", "MaxInvulnerables", "KickThreshold", "pot_account"]; Session: ["KeyDeposit"]; Aura: ["SlotDuration"]; XcmpQueue: ["MaxInboundSuspended", "MaxActiveOutboundChannels", "MaxPageSize"]; PolkadotXcm: ["UniversalLocation", "AdvertisedXcmVersion", "MaxLockers", "MaxRemoteLockConsumers"]; MessageQueue: ["HeapSize", "MaxStale", "ServiceWeight", "IdleMaxServiceWeight"]; Utility: ["batched_calls_limit"]; Multisig: ["DepositBase", "DepositFactor", "MaxSignatories"]; Proxy: ["ProxyDepositBase", "ProxyDepositFactor", "MaxProxies", "MaxPending", "AnnouncementDepositBase", "AnnouncementDepositFactor"]; Indices: ["Deposit"]; Assets: ["RemoveItemsLimit", "AssetDeposit", "AssetAccountDeposit", "MetadataDepositBase", "MetadataDepositPerByte", "ApprovalDeposit", "StringLimit"]; Uniques: ["CollectionDeposit", "ItemDeposit", "MetadataDepositBase", "AttributeDepositBase", "DepositPerByte", "StringLimit", "KeyLimit", "ValueLimit"]; Nfts: ["CollectionDeposit", "ItemDeposit", "MetadataDepositBase", "AttributeDepositBase", "DepositPerByte", "StringLimit", "KeyLimit", "ValueLimit", "ApprovalsLimit", "ItemAttributesApprovalsLimit", "MaxTips", "MaxDeadlineDuration", "MaxAttributesPerCall", "Features"]; ForeignAssets: ["RemoveItemsLimit", "AssetDeposit", "AssetAccountDeposit", "MetadataDepositBase", "MetadataDepositPerByte", "ApprovalDeposit", "StringLimit"]; PoolAssets: ["RemoveItemsLimit", "AssetDeposit", "AssetAccountDeposit", "MetadataDepositBase", "MetadataDepositPerByte", "ApprovalDeposit", "StringLimit"]; AssetConversion: ["LPFee", "PoolSetupFee", "PoolSetupFeeAsset", "LiquidityWithdrawalFee", "MintMinLiquidity", "MaxSwapPathLength", "PalletId"]; Treasury: ["SpendPeriod", "Burn", "PalletId", "MaxApprovals", "PayoutPeriod", "pot_account"]; ConvictionVoting: ["MaxVotes", "VoteLockingPeriod"]; Referenda: ["SubmissionDeposit", "MaxQueued", "UndecidingTimeout", "AlarmInterval", "Tracks"]; Bounties: ["BountyDepositBase", "BountyDepositPayoutDelay", "BountyUpdatePeriod", "CuratorDepositMultiplier", "CuratorDepositMax", "CuratorDepositMin", "BountyValueMinimum", "DataDepositPerByte", "MaximumReasonLength"]; ChildBounties: ["MaxActiveChildBountyCount", "ChildBountyValueMinimum"]; MultiAssetBounties: ["BountyValueMinimum", "ChildBountyValueMinimum", "MaxActiveChildBountyCount"]; StateTrieMigration: ["MaxKeyLen"]; NominationPools: ["PalletId", "MaxPointsToBalance", "MaxUnbonding"]; VoterList: ["BagThresholds", "MaxAutoRebagPerBlock"]; DelegatedStaking: ["PalletId", "SlashRewardFraction"]; StakingRcClient: ["KeyDeposit"]; MultiBlockElection: ["UnsignedPhase", "SignedPhase", "SignedValidationPhase", "VoterSnapshotPerBlock", "TargetSnapshotPerBlock", "Pages"]; MultiBlockElectionVerifier: ["MaxBackersPerWinnerFinal", "MaxBackersPerWinner", "MaxWinnersPerPage"]; Staking: ["HistoryDepth", "SessionsPerEra", "PlanningEraOffset", "BondingDuration", "NominatorFastUnbondDuration", "SlashDeferDuration", "DisableMinting", "MaxExposurePageSize", "MaxValidatorSet", "MaxUnlockingChunks", "MaxEraDuration", "MaxPruningItems"]; MembersSubscriber: ["RingRootsNotifier", "SelfParaId", "MaxMissingRootsPerCollection", "MaxDeletedRingsPerCollection", "MaxRingRootsPerCollection", "MaxCollections", "ReplayCooldownSeconds", "MaxUpdatesPerBatch", "ReplayWarningThreshold", "ReplayAbandonThreshold", "MaxRecentRootsPerRing", "OffchainWorkerInterval"]; AliasAccounts: ["ProofValidityWindow", "CleanupGracePeriod", "PeopleLiteRingExponent", "PeopleRingExponent", "PeopleCollectionIdentifier", "PeopleLiteCollectionIdentifier"]; Pgas: ["PgasAssetId", "PgasClaimAmount", "MaxClaimsPerPeriodPerPerson", "MaxClaimsPerPeriodPerLitePerson", "MaxPgasClaimRecordCleanupPerCall"]; Revive: ["DepositPerByte", "DepositPerItem", "DepositPerChildTrieItem", "CodeHashLockupDepositPercent", "AllowEVMBytecode", "ChainId", "NativeToEthRatio", "MaxEthExtrinsicWeight", "DebugEnabled", "AutoMap", "GasScale"]; AssetsPrecompilesPermit: ["ChainId"]; DotnsGateway: ["MaxContractCallWeight", "MaxValiditySeconds", "MaxFutureSkewSeconds"] }; viewFns: { MultiBlockMigrations: ["ongoing_status", "progress", "affected_prefixes", "status"]; Dap: ["budget_recipients", "staging"]; Proxy: ["check_permissions", "is_superset"]; Assets: ["asset_details", "balance_of", "get_metadata", "get_reserves_data"]; ForeignAssets: ["asset_details", "balance_of", "get_metadata", "get_reserves_data"]; PoolAssets: ["asset_details", "balance_of", "get_metadata", "get_reserves_data"]; AssetConversion: ["get_reserves", "quote_price_exact_tokens_for_tokens", "quote_price_tokens_for_exact_tokens"]; VoterList: ["scores"]; MultiBlockElectionSigned: ["deposit_for"]; Staking: ["pot_account", "pot_balance", "era_reward_allocation"] }; apis: { AuraApi: ["slot_duration", "authorities"]; RelayParentOffsetApi: ["relay_parent_offset"]; AuraUnincludedSegmentApi: ["can_build_upon"]; Core: ["version", "execute_block", "initialize_block"]; Metadata: ["metadata", "metadata_at_version", "metadata_versions"]; BlockBuilder: ["apply_extrinsic", "finalize_block", "inherent_extrinsics", "check_inherents"]; TaggedTransactionQueue: ["validate_transaction"]; OffchainWorkerApi: ["offchain_worker"]; SessionKeys: ["generate_session_keys", "decode_session_keys"]; RuntimeViewFunction: ["execute_view_function"]; AccountNonceApi: ["account_nonce"]; TransactionPaymentApi: ["query_info", "query_fee_details", "query_weight_to_fee", "query_length_to_fee"]; TransactionPaymentCallApi: ["query_call_info", "query_call_fee_details", "query_weight_to_fee", "query_length_to_fee"]; XcmPaymentApi: ["query_acceptable_payment_assets", "query_xcm_weight", "query_weight_to_asset_fee", "query_delivery_fees"]; DryRunApi: ["dry_run_call", "dry_run_xcm"]; LocationToAccountApi: ["convert_location"]; TrustedQueryApi: ["is_trusted_reserve", "is_trusted_teleporter"]; AuthorizedAliasersApi: ["authorized_aliasers", "is_authorized_alias"]; FungiblesApi: ["query_account_balances"]; CollectCollationInfo: ["collect_collation_info"]; GenesisBuilder: ["build_state", "get_preset", "preset_names"]; AssetConversionApi: ["quote_price_tokens_for_exact_tokens", "quote_price_exact_tokens_for_tokens", "get_reserves"]; GetParachainInfo: ["parachain_id"]; NominationPoolsApi: ["pending_rewards", "points_to_balance", "balance_to_points", "pool_pending_slash", "member_pending_slash", "pool_needs_delegate_migration", "member_needs_delegate_migration", "member_total_balance", "pool_balance", "pool_accounts"]; StakingApi: ["nominations_quota", "eras_stakers_page_count", "pending_rewards"]; Inflation: ["experimental_issuance_prediction_info"]; ReviveApi: ["eth_block", "eth_block_hash", "eth_receipt_data", "block_gas_limit", "max_extrinsic_weight_in_gas", "balance", "gas_price", "nonce", "call", "instantiate", "eth_transact", "eth_transact_with_config", "eth_estimate_gas", "eth_pre_dispatch_weight", "upload_code", "get_storage", "get_storage_var_key", "trace_block", "trace_tx", "trace_call", "trace_call_with_config", "block_author", "address", "account_id", "runtime_pallets_address", "code", "new_balance_with_dust"] } };
export type Assethub_paseoWhitelistEntry = PalletKey | `query.${NestedKey<AllInteractions["storage"]>}` | `tx.${NestedKey<AllInteractions["tx"]>}` | `event.${NestedKey<AllInteractions["events"]>}` | `error.${NestedKey<AllInteractions["errors"]>}` | `const.${NestedKey<AllInteractions["constants"]>}` | `view.${NestedKey<AllInteractions["viewFns"]>}` | `api.${NestedKey<AllInteractions["apis"]>}`;
