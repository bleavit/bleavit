...
type IStorage = {
  System: {
     ...
     */
    Events: StorageDescriptor<[], Anonymize<I6rvl2tddf6nom>, false, never>;
    /**
...
type IEvent = {
  System: {
     ...
     * An extrinsic failed.
     */
    ExtrinsicFailed: PlainDescriptor<Anonymize<I8bq3skkh4cj5b>>;
    /**
     ...
     */
    RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<Iahdi73ndhok2k>>;
  };
  ParachainSystem: {
    /**
  ...
  Scheduler: {
     ...
     */
    Dispatched: PlainDescriptor<Anonymize<I67pk6j8bfvk68>>;
    /**
  ...
  Utility: {
     ...
     * well as the error.
     */
    BatchInterrupted: PlainDescriptor<Anonymize<Idinne5793ckgq>>;
    /**
     ...
     */
    ItemFailed: PlainDescriptor<Anonymize<I6vcusuqarerns>>;
    /**
     * A call was dispatched.
     */
    DispatchedAs: PlainDescriptor<Anonymize<I3s4aihhkpms95>>;
    /**
     ...
     */
    IfElseFallbackCalled: PlainDescriptor<Anonymize<Iee4b5i3vbrrj6>>;
  };
  Proxy: {
    /**
     * A proxy was executed correctly, with the given.
     */
    ProxyExecuted: PlainDescriptor<Anonymize<I3s4aihhkpms95>>;
    /**
  ...
  Multisig: {
     ...
     */
    MultisigExecuted: PlainDescriptor<Anonymize<I57bnuu8jh7bik>>;
    /**
  ...
  Sudo: {
     ...
     */
    Sudid: PlainDescriptor<Anonymize<Ick5uthk4o2udn>>;
    /**
     ...
     */
    SudoAsDone: PlainDescriptor<Anonymize<Ick5uthk4o2udn>>;
  };
  XcmpQueue: {
    /**
...
type IRuntimeCalls = {
  ...
  BlockBuilder: {
     ...
     * this block or not.
     */
    apply_extrinsic: RuntimeDescriptor<[extrinsic: Uint8Array], Anonymize<Inohmgb3g4pbh>>;
    /**
...
export type BleavitDispatchError = Anonymize<Iftks7pco8m7bq>;
...
export type Bleavit = { descriptors: { pallets: PalletsTypedef; apis: IRuntimeCalls } & Promise<any>; metadataTypes: Promise<Uint8Array>; asset: IAsset; extensions: BleavitExtensions; getMetadata: () => Promise<Uint8Array>; genesis: string | undefined };
